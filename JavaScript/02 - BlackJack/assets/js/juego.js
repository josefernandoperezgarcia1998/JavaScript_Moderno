const miModulo = ( () => {
    ...
    // Turno 0: 1er jugador y el último serála computadora
    ...
    // Por si otros programadores, o ciertas personas quieran acceder a cierta parte del código se le puede permitir por medio de esto
    return {
